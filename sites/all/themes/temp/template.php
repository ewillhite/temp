...
/*
function temp_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}

function temp_preprocess_page(&$vars,$hook) {
  //typekit
...
function temp_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
function temp_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
}

function temp_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}

function temp_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
function temp_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/